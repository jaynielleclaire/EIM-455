new gridjs.Grid({
  columns: [
    { name: "No.", width: "10%" },
    { name: "Problem Classification", width: "30%" },
    { name: "Interview Quote", width: "50%" }
  ],
  data: [
...
new gridjs.Grid({
  columns: [
    { name: "Apron", width: "20%" },
    { name: "0.50 mm Xenolite [11]", width: "30%" },
    { name: "0.50 mm Xenolite [11]", width: "30%" },
    { name: "0.50 mm Lead [12]", width: "30%" },
    { name: "0.50 mm Lead [12]", width: "30%" }
  ],
  data: [
    [gridjs.html("<b>Energy level</b>"), 
    gridjs.html("<b>Transmission rate</b>"),
    gridjs.html("<b>Density</b>"),
    gridjs.html("<b>Transmission rate</b>"),
    gridjs.html("<b>Density</b>")
    ],
...
new gridjs.Grid({
  columns: [
    ...
    { name: "Criteria", width: "20%" },
    { name: "Concept 1: 'LatticeGuard Pro'", width: "40%" },
    { name: "Concept 2: 'SuspendShield Flex'", width: "40%" },
    { name: "Concept 3: 'NanoTech ArtiFit'", width: "40%" },
  ],
  data: [
